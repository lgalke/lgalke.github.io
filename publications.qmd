...
- [j6] Lukas Galke, Andor Diera, Bao Xin Lin, Bhakti Khera, Tim Meuser, Tushar Singal, Fabian Karl, Ansgar Scherp (submitted). [Are We Really Making Much Progress? Bag-of-Words vs. Sequence vs. Graph vs. Hierarchy for Single-label and Multi-label Text Classification](https://arxiv.org/abs/2204.03954).
...
- [c4] Lukas Galke, Florian Mai, Iacopo Vagliano (2018). Multi-Modal Adversarial Autoencoders for Recommendation of Citations and Subject Labels. In *Conference on User Modeling, Adaptation and Personalization (UMAP)*. ACM. [https://doi.org/10.1145/3209219.3209236](https://doi.org/10.1145/3209219.3209236)
