...
- [code for single-label classification extended with more methods](https://github.com/FKarl/text-classification)
- [code for single-label classification (as used in the ACL paper)](https://github.com/lgalke/text-clf-baselines)
...
- *two more journal papers currently under review*
...
- [dataset paper](https://doi.org/10.1109/BigData52589.2021.9671730).
- [paper on learning concept representations](https://doi.org/10.18420/inf2019_26)
...
- [paper on data enrichment 2](https://ceur-ws.org/Vol-2773/paper-09.pdf)
- [paper on data enrichment 1](https://ceur-ws.org/Vol-2451/paper-23.pdf)
- [tools for harvesting raw data](https://github.com/Q-AKTIV/covid19-harvesting-tools)
- [project website](https://q-aktiv.github.io)
- [interview about open science tools for digital collaboration](https://www.zbw-mediatalk.eu/de/2019/03/praxisbericht-open-science-diese-tools-foerdern-die-zusammenarbeit/)
...
## Autoencoders for Document-based Recommendations (aerec) {#aerec}
...
- [code for recommender systems](https://github.com/lgalke/aae-recommender)
...
The key idea was to use word
embeddings for similarity scoring in information retrieval. The two main
take-aways:
