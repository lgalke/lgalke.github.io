...
- Andrea Blasi Nunez, Lukas Galke Poech, & Peter Schneider-Kamp (to appear). Teaching Old Dogs New Tricks: Teacher Signal vs. Experience Replay in Continual Pre-training for Language Model Adaptation. Accepted at International Conference on Artificial Neural Networks (ICANN).
- Filippo Tonini, Federico Torrielli, Anton Danholt Lautrup, Peter Schneider-Kamp, Mustafa Mert Çelikok, & Lukas Galke Poech (to appear). The Arbiter Agent: Continually Monitoring Multi-Agent Conversations to Detect Emergent Misalignment. Accepted at AI Transparecy Conference (AITC).
